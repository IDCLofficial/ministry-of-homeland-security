...
const info = {
  ...
  ministry: "Ministry of Homeland Security and Vigilante Affairs",
  description: "The Imo State Ministry of Homeland Security and Vigilante Affairs was created by the administration of His Excellency, Distinguished Senator Hope Uzodinma: the Governor of Imo State to facilitate the transformation of Imo State ",
  quickLinks: [
  ...
  contact: [
    ...
    { label: "info.imominofhomeland@gmail.com", href: "mailto:info.imominofhomeland@gmail.com" },
  ],
};
...
export default function Footer() {
  ...
  return (
    ...
    <div className="mx-auto flex flex-col lg:flex-row justify-between gap-8 pb-8 max-w-5xl">
      ...
      Copyright © {new Date().getFullYear()} Imo State Ministry of Homeland Security and Vigilante Affairs. All rights reserved. Powered by{' '}
      <a 
