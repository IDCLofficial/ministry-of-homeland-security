    ...
    {/* // <section className="w-full bg-[#f4f8f9] h-screen md:h-[80vh] py-16 flex justify-center"> */}
     <div className="w-[94%] max-w-6xl mx-auto flex flex-col md:flex-row items-stretch gap-16">
        ...
        <div className="flex-shrink-0 flex items-stretch">
          <div className="relative w-[90vw] md:w-[580px] h-full min-h-[396px] md:min-h-0 md:h-full rounded-2xl overflow-hidden bg-white shadow flex-1">
            <Image
              src={imageSrc}
              alt={imageAlt}
              fill
        ...
        <div className="flex-1 flex flex-col md:items-start px-2 w-full">
          ...
          <Link href="/services" className="w-max px-3 md:px-7 py-3 bg-green-600 text-white rounded text-sm font-semibold shadow hover:bg-green-700 transition">
            <button>
              What we Do
            </button>
          </Link>
